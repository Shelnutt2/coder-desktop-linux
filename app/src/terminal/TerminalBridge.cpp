    ...
    : QObject(parent)
{
    ...
    connect(&m_ws, &TerminalWebSocket::outputReceived, this,
            [this](const QString &data) {
                emit outputReceived(
                    QString::fromLatin1(data.toUtf8().toBase64()));
            });

    connect(&m_ws, &WebSocketBase::connectionStateChanged,
            this, [this]() {
...
void TerminalBridge::setCredentials(const QString &baseUrl,
                                    const QString &token)
{
