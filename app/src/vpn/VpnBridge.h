...
signals:
    ...
    void peerUpdated(const QString& workspace, const QString& agent,
                     const QString& hostname, int status,
                     int lastPingMs, bool isP2P);

private slots:
    void onStateChanged(const QString& newState, const QString& errorMessage);
    void onPeerUpdated(const QString& workspace, const QString& agent,
                       const QString& hostname, int status,
                       int lastPingMs, bool isP2P);
