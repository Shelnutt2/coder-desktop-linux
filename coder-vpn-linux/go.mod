module github.com/coder/coder-vpn-linux
...
// Required replace directives inherited from coder/coder v2.30.1.
// coder/coder uses forks of tailscale and wireguard-go with additional patches.
...
// Pin tailscale's x/crypto fork to the version expected by the coder/tailscale fork.
replace github.com/tailscale/golang-x-crypto => github.com/tailscale/golang-x-crypto v0.0.0-20230713185742-f0b76a10a08e

// Pin gvisor to the version expected by the coder/tailscale fork.
