...
static void handle_request_set_selection(struct wl_listener* listener, void* data) {
    struct coder_dlp_compositor* comp = wl_container_of(listener, comp, request_set_selection);
...
void dlp_clipboard_init(struct coder_dlp_compositor* comp) {
    ...
    comp->request_set_primary_selection.notify = handle_request_set_primary_selection;
